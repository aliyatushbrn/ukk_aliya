...
<head>
  ...
  <title>Login Charming Beauty</title>
          ...
          <div class="card-body">
            ...
            <div class="app-brand justify-content-center">
              <a href="index.html" class="app-brand-link gap-2">
                <span class="app-brand-text demo text-body fw-bolder" style="text-transform: capitalize">Charming
                  Beauty</span>
              </a>
            </div>
            <!-- /Logo -->
            <form class="mb-3" action="<?= base_url('auth/login') ?>" method="POST">
              ...
              <div class="mb-3">
                <button class="btn btn-primary d-grid w-8" type="submit">Log in</button>
              </div>
              <p class="text-center">
